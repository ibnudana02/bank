...
OrgChart.prototype.load = function (t) {
    ...
    var s = OrgChart._arrayContains(this.node.tags, "Audit") ? "checked" : "";
    l.setAttribute("data-field-name", "isAudit"), l.innerHTML = '<div style="margin-top: 10px;display:inline-block;">Audit</div><label class="bg-switch"><input val type="checkbox" ' + s + '><span class="bg-slider round"></span></label>', this.wrapperElement.appendChild(e), e.appendChild(r), e.appendChild(n), r.appendChild(a), OrgChart.htmlRipple(r);
    var h = this.fields,
    ...
    t.isGroup || t.isChildOfGroup || 0 != t.childrenIds.length || this._addField(n, l, "isAudit", "edit"), t.isGroup || this._addField(n, o, "Add new field", "edit"), this.obj.element.appendChild(this.wrapperElement), r.addEventListener("click", function () {
        i.hide(!0)
            ...
            for (var r = this.wrapperElement.querySelectorAll("[data-field-name]"), i = 0; i < r.length; i++) {
                ...
                if (a) {
                    ...
                    if (a === OrgChart.TAGS) e.tags = o.split(",");
                        ...
                        n && e.tags ? OrgChart._arrayContains(this.node.tags, "Audit") || e.tags.push("Audit") : n && !e.tags ? e.tags = ["Audit"] : !n && e.tags && -1 != this.node.tags.indexOf("Audit") && e.tags.splice(e.tags.indexOf("Audit"), 1)
    ...
    for (var e in this.nodes) {
        this.destroy, (0 != (i = this.nodes[e]).childrenIds.length || 0 == i.childrenIds.length && null == i.pid) && (i.isAudit || "split" == i.templateName || g.push(i.id))
    }
    ...
    for (var e in this.nodes) {
        var r = this.nodes[e];
        (0 != r.childrenIds.length || 0 == r.childrenIds.length && null == r.pid) && (r.isAudit || "split" == r.templateName || g.push(r.id))
    }
    ...
    this.templateName = i, this.id = t, this.pid = e, this.x = null, this.y = null, this.level = null, this.leftNeighbor = null, this.rightNeighbor = null, this._prelim = 0, this._modifier = 0, this.children = [], this.parent = null, this.isAudit = !1, this.tags = r, this.collapsedChildrenIds = [], this.childrenIds = [];
    ...
    0 < t.children.length && (i.c = OrgChart.remote._convertToIdArray(t.children)), null != t.layout && 0 != t.layout && (i.l = t.layout), t.isAudit && (i.a = 1), t.templateName != r && (i.t = t.templateName), e.push(i);
    ...
    for (var i = a.nodes, o = {}, n = [], l = [], s = [], h = {}, d = !1, c = 0; c < i.length; c++) {
        ...
        if ((v = new OrgChart.node(g.id, g.pid, p, u)).isAudit = -1 != p.indexOf("Audit"), v.isAudit && -1 == s.indexOf(v.pid) && OrgChart.server._isNotNullEmptyUndefined(v.pid) && s.push(v.pid), null != f) {
            if (!o[f.name]) {
                n.push(f.name);
            ...
            v.isChildOfGroup = !0, v._groupParentNodeId = f.name, o[f.name].bgnodes.push(v), 1 == v.isAudit && (o[f.name].isAudit = !0), h[v.id] = f.name, d = !0
    ...
    for (c = 0; c < n.length; c++) {
        var O = n[c],
            v = o[O],
            y = r ? r[O] : null;
        if (OrgChart.server._isNotNullEmptyUndefined(v.pid))(H = o[v.pid]) ? ((v.parent = H).children.push(v), H.childrenIds.push(v.id)) : (v.pid = null, v.parent = null, v.isAudit = !1, l.push(v));
        else v.isAudit = !1, l.push(v);
    ...
    for (c = 0; c < s.length; c++) {
        ...
        if (H) {
            ...
            (o[_.id] = _).isAudit = !0, (y = r[_.id]) && (o[_.id].state = y.state, o[_.id].state == OrgChart.COLLAPSE && m.push(_.id)), OrgChart.server._initStates(_, o, t, a, e, m);
            var k = [];
            for (b = H.children.length - 1; 0 <= b; b--) {
                (z = H.children[b]).isAudit ? (z.parent = null, H.children.splice(b, 1), H.childrenIds.splice(b, 1), k.splice(0, 0, z.id)) : (z.pid = _.id, (z.parent = _).children.unshift(z), _.childrenIds.unshift(z.id), H.children.splice(b, 1))
            }
            if (k.length % 2) {
                ...
                OrgChart.templates[I] = {
                    ...
                    nodeMenuButton: "",
                    size: S
                }, (W = new OrgChart.node(H.id + "_transperant", A.pid, [], I)).isAudit = !0, o[W.id] = W, k.splice(k.length - 1, 0, W.id)
            }
            var N = 1;
            for (b = k.length - 1; 0 <= b; b--) {
                if (b % 2 && b != k.length - 1)(J = new OrgChart.node(H.id + "_split_" + N, null, [], "split")).isAudit = !0, o[J.id] = J, k.splice(b, 0, J.id), N++;
            ...
            for (b = 0; b < k.length; b += 3) {
                ...
                (y = r[L.id]) && (o[L.id].state = y.state, o[L.id].state == OrgChart.COLLAPSE && m.push(L.id)), OrgChart.server._initStates(L, o, t, a, e, m)
            }
        }
    }
    if (t == OrgChart.action.centerNode) {
        ...
        for (var H = OrgChart.server._getRealParent(P), U = P.id; null != H;) {
            if (-1 != (D = m.indexOf(H.id)) && m.splice(D, 1), H.state = OrgChart.EXPAND, e.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS)
                for (c = 0; c < H.childrenIds.length; c++) {
                    ...
                    if (!OrgChart.server._isSplit(z) && !z.isAudit && z.id != U) - 1 == (D = m.indexOf(H.childrenIds[c])) && m.push(H.childrenIds[c]), z.state = OrgChart.COLLAPSE
                }
            if (H.state == OrgChart.EXPAND)
                for (var F = 0; F < H.childrenIds.length; F++) {
                    var j = o[H.childrenIds[F]];
                    if (OrgChart.server._isSplit(j) || j.isAudit) - 1 != (D = m.indexOf(j.id)) && m.splice(D, 1), j.state = OrgChart.EXPAND
                }
        ...
        if (e.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
            for (c = 0; c < P.childrenIds.length; c++) {
                if (-1 != (D = m.indexOf(P.childrenIds[c])) && m.splice(D, 1), (z = o[P.childrenIds[c]]).state = OrgChart.EXPAND, !z.isAudit && !OrgChart.server._isSplit(z))
    ...
    if (a.layout == OrgChart.mixed)
        for (c = 0; c < n.length; c++) {
            if (0 == (v = o[n[c]]).childrenIds.length && !v.isAudit && "split" != v.templateName)
                if (H = v.parent) {
                    if (!OrgChart.server._mixedLayoutAllNodes(H)) continue;
                    for (b = H.children.length - 1; 0 <= b; b--) {
                        if ((z = H.children[b]) != v && 0 == z.childrenIds.length && !z.isAudit && "split" != z.templateName) {
    ...
    if (a.layout == OrgChart.tree || a.layout == OrgChart.treeRightOffset || a.layout == OrgChart.treeLeftOffset) {
        var q = [];
        for (c = 0; c < n.length; c++) {
            if (0 == (v = o[n[c]]).childrenIds.length && !v.isAudit && "split" != v.templateName)(H = v.parent) && -1 == q.indexOf(H.id) && q.push(H.id)
        }
        for (c = 0; c < q.length; c++) {
            ...
            for (b = H.children.length - 1; 0 <= b; b--) {
                if (OrgChart.server._mixedLayoutAllNodes(H))
                    if (0 == (z = H.children[b]).childrenIds.length && !z.isAudit && "split" != z.templateName && (z.parent && "split" != z.parent.templateName || z.parent.isAudit)) {
    ...
    for (var e = t.children.length - 1; 0 <= e; e--) {
        var r = t.children[e];
        if (0 < r.childrenIds.length || r.isAudit || "split" == r.templateName) return !1
    }
    return !0
    ...
    link: function (t, e, r, i) {
        ...
        for (var l = 0; l < t.children.length; l++) {
            ...
            if ((s.isAudit || 2 == s.layout) && s.rightNeighbor && "split" == s.rightNeighbor.templateName) switch (r.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                ...
                case OrgChart.orientation.left_top:
                    h = OrgChart.ui._linkBottomToTop(s.rightNeighbor, s, a, n)
            } else if ((s.isAudit || 2 == s.layout) && s.leftNeighbor && "split" == s.leftNeighbor.templateName) switch (r.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
    ...
    _linkTopToBottom: function (t, e, r, i) {
        ...
        return a = t.x + t.w / 2 + r.linkAdjuster.toX, o = t.y + t.h + r.linkAdjuster.toY, s = l = e.x + e.w / 2 + r.linkAdjuster.fromX, h = e.y + r.linkAdjuster.fromY, {
            ...
            ya: o,
            xb: n,
            yb: c = t.rightNeighbor && t.rightNeighbor.isAudit && "split" == e.templateName ? t.rightNeighbor.y + t.rightNeighbor.h + i : "split" != t.templateName || !e.isAudit && 2 != e.layout ? "split" == e.templateName ? o + i : h - i : h,
            xc: d = l,
            yc: c,
            xd: s,
            yd: h,
    ...
    _linkBottomToTop: function (t, e, r, i) {
        ...
        return a = t.x + t.w / 2 + r.linkAdjuster.toX, o = t.y + r.linkAdjuster.toY, s = l = e.x + e.w / 2 + r.linkAdjuster.fromX, h = e.y + e.h + r.linkAdjuster.fromY, {
            ...
            ya: o,
            xb: n,
            yb: c = t.rightNeighbor && t.rightNeighbor.isAudit && "split" == e.templateName ? t.rightNeighbor.y - i : "split" != t.templateName || !e.isAudit && 2 != e.layout ? "split" == e.templateName ? o - i : h + i : h,
            xc: d = l,
            yc: c,
            xd: s,
            yd: h,
    ...
    _linkRightToLeft: function (t, e, r, i) {
        ...
        return a = t.x + r.linkAdjuster.toX, o = t.y + t.h / 2 + r.linkAdjuster.toY, s = e.x + e.w + r.linkAdjuster.fromX, h = l = e.y + e.h / 2 + r.linkAdjuster.fromY, {
            xa: a,
            ya: n = o,
            xb: c = t.rightNeighbor && t.rightNeighbor.isAudit && "split" == e.templateName ? t.rightNeighbor.x - i : "split" != t.templateName || !e.isAudit && 2 != e.layout ? "split" == e.templateName ? a - i : s + i : s,
            yb: n,
            xc: c,
            yc: d = l,
            xd: s,
    ...
    _linkLeftToRight: function (t, e, r, i) {
        ...
        return a = t.x + t.w + r.linkAdjuster.toX, o = t.y + t.h / 2 + r.linkAdjuster.toY, s = e.x + r.linkAdjuster.fromX, h = l = e.y + e.h / 2 + r.linkAdjuster.fromY, {
            xa: a,
            ya: n = o,
            xb: c = t.rightNeighbor && t.rightNeighbor.isAudit && "split" == e.templateName ? t.rightNeighbor.x + t.rightNeighbor.w + i : "split" != t.templateName || !e.isAudit && 2 != e.layout ? "split" == e.templateName ? a + i : s - i : s,
            yb: n,
            xc: c,
            yc: d = l,
            xd: s,
