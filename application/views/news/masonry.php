<div id="portfolio" class="grid-layout portfolio-3-columns" data-margin="0">
        ...
        <div class="portfolio-item-wrap">
            <div class="portfolio-slider">
                <div class="carousel dots-inside dots-dark arrows-dark" data-items="1" data-loop="true" data-autoplay="true" data-animate-in="fadeIn" data-animate-out="fadeOut" data-autoplay="1500">
                    <a href="#"><img src="<?= base_url('assets/new/') ?>images/portfolio/64.jpg" alt="" /></a>
    ...
    <div class="portfolio-item img-zoom ct-photography ct-marketing ct-media">
        <div class="portfolio-item-wrap">
            <div class="portfolio-image">
                <a href="#"><img src="<?= base_url('assets/new/') ?>images/portfolio/60.jpg" alt="" /></a>
            </div>
    ...
    <div class="portfolio-item img-zoom ct-photography ct-media ct-branding ct-Media">
        <div class="portfolio-item-wrap">
            <div class="portfolio-image">
                <a href="#"><img src="<?= base_url('assets/new/') ?>images/portfolio/61.jpg" alt="" /></a>
            </div>
            <div class="portfolio-description">
    ...
    <div class="portfolio-item img-zoom ct-photography ct-media ct-branding ct-marketing ct-webdesign">
        <div class="portfolio-item-wrap">
            <div class="portfolio-image">
                <a href="#"><img src="<?= base_url('assets/new/') ?>images/portfolio/65.jpg" alt="" /></a>
            </div>
    ...
    <div class="portfolio-item img-zoom ct-marketing ct-media ct-branding ct-marketing ct-webdesign">
        <div class="portfolio-item-wrap">
            <div class="portfolio-image">
                <a href="#"><img src="<?= base_url('assets/new/') ?>images/portfolio/66.jpg" alt="" /></a>
            </div>
            <div class="portfolio-description">
                <a href="portfolio-page-grid-gallery.html">
    ...
    <div class="portfolio-item img-zoom ct-photography ct-media ct-branding ct-marketing ct-webdesign">
        <div class="portfolio-item-wrap">
            <div class="portfolio-image">
                <a href="#"><img src="<?= base_url('assets/new/') ?>images/portfolio/67.jpg" alt="" /></a>
            </div>
            <div class="portfolio-description">
    ...
    <div class="portfolio-item no-overlay ct-photography ct-media ct-branding ct-Media ct-marketing ct-webdesign">
        <div class="portfolio-item-wrap">
            <div class="portfolio-slider">
                <div class="carousel dots-inside dots-dark arrows-dark" data-items="1" data-loop="true" data-autoplay="true" data-animate-in="fadeIn" data-animate-out="fadeOut" data-autoplay="1500">
                    <a href="#"><img src="<?= base_url('assets/new/') ?>images/portfolio/68.jpg" alt="" /></a>
                    <a href="#"><img src="<?= base_url('assets/new/') ?>images/portfolio/71.jpg" alt="" /></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="portfolio-item img-zoom ct-photography ct-marketing ct-media">
        <div class="portfolio-item-wrap">
            <div class="portfolio-image">
                <a href="#"><img src="<?= base_url('assets/new/') ?>images/portfolio/69.jpg" alt="" /></a>
            </div>
            <div class="portfolio-description">
                <a href="portfolio-page-grid-gallery.html">
                    <h3>Luxury Wine</h3>
