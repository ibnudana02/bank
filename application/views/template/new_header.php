        ...
        <header id="header">
            <div class="header-inner">
                <div class="container">
                    ...
                    <!-- <div id="logo"> <a href="index.html"><span class="logo-default">Bank</span><span class="logo-dark">Bank</span></a> </div> -->
                    <div id="logo"> <a href="index.html"><img src="<?php echo base_url('assets/'); ?>img/logo/unisri-logo.png" class="logo-default" alt=""></a> </div>
