...
<!-- <div class="row"> -->
<div id="slider" class="inspiro-slider col-lg wow fadeInLeft" data-height-xs="460">
        ...
        <table border="0" cellspacing="2" cellpadding="7" style="font-family: Tahoma,Geneva,sans-serif;font-size: 12px;font-weight: normal;width: auto;background-color: #ffffff;height: auto;border-color: #ffffff;margin-left: auto;margin-right: auto;">
            <tbody>
                <tr style="height: 20px;">
                    <td class="background-grey" colspan="2" style="height: 20px; text-align: center; width: 270px;"><strong>Suku Bunga :</strong></td>
                </tr>
                ...
                <?php endforeach; ?>
                <tr style="height: 20px;">
                    <td class="background-grey" colspan="2" style="height: 20px; text-align: center; width: 270px;"><strong>Tabungan :</strong></td>
                </tr>
                ...
                <?php endforeach; ?>
                <tr style="height: 20px;">
                    <td class="background-grey" colspan="2" style="height: 20px; text-align: center; width: 270px;"><strong>Deposito :</strong></td>
                </tr>
                ...
                <?php endforeach; ?>
                <tr style="height: 20px;">
                    <td class="background-grey" colspan="2" style="height: 20px; text-align: center; width: 270px;"><strong>Jam Kerja :</strong></td>
                </tr>
