        <div id="slider" class="inspiro-slider" data-height-xs="360">
            ...
            <div class="slide" style="background-image:url('<?= base_url('assets/new/') ?>homepages/corporate-v8/images/slider/1.jpg');">
                <div class="container">
            ...
            <div class="slide" style="background-image:url('<?= base_url('assets/new/') ?>homepages/corporate-v8/images/slider/2.jpg');">
                <div class="container">
        ...
        <section class="background-grey text-center p-t-60  p-b-40">
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                        <h3 style="font-weight: 100;">Brace yourself! More demo layouts are comming!</h3>
                    </div>
                    <div class="col-lg-3"><a type="button" class="btn btn-rounded">Purchase POLO</a> </div>
                </div>
            </div>
        </section>
        ...
        <section class="p-b-20">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <img src="<?= base_url('assets/new/') ?>images/mockup/1.jpg" class="img-fluid m-b-20">
                    ...
                    <div class="col-lg-4">
                        <img src="<?= base_url('assets/new/') ?>images/mockup/2.jpg" class="img-fluid m-b-20">
                    ...
                    <div class="col-lg-4">
                        <img src="<?= base_url('assets/new/') ?>images/mockup/3.jpg" class="img-fluid m-b-20">
                        <h4>Powerful</h4>
                        <p>We’re POLO, a creative agency located in the heart of New York city. A true story, that never been told!. Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, facilisis ut venenatis eu.</p>
                    </div>
        ...
        <section class="p-b-40">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <h4><i class="fa fa-heart"></i> Fully Responsive</h4>
                        <p>We’re POLO, a creative agency located in the heart of New York city. A true story, that never been told!. Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, facilisis ut venenatis eu.</p>
                    </div>


                    <div class="col-lg-4">
                        <h4><i class="fa fa-gear"></i> Tons of Options</h4>
                        <p>We’re POLO, a creative agency located in the heart of New York city. A true story, that never been told!. Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, facilisis ut venenatis eu.</p>
                    </div>


                    <div class="col-lg-4">
                        <h4><i class="fa fa-plug"></i> Powerful</h4>
                        <p>We’re POLO, a creative agency located in the heart of New York city. A true story, that never been told!. Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, facilisis ut venenatis eu.</p>
                    </div>


                    <div class="col-lg-4">
                        <h4><i class="fa fa-trophy"></i> Easy to Customize</h4>
                        <p>We’re POLO, a creative agency located in the heart of New York city. A true story, that never been told!. Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, facilisis ut venenatis eu.</p>
                    </div>


                    <div class="col-lg-4">
                        <h4><i class="far fa-lightbulb"></i> Fast as light</h4>
                        <p>We’re POLO, a creative agency located in the heart of New York city. A true story, that never been told!. Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, facilisis ut venenatis eu.</p>
                    </div>


                    <div class="col-lg-4">
                        <h4><i class="fa fa-desktop"></i> Flexible Layouts</h4>
                        <p>We’re POLO, a creative agency located in the heart of New York city. A true story, that never been told!. Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, facilisis ut venenatis eu.</p>
                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="post-thumbnail-list">
                            <div class="post-thumbnail-entry">
                                <img src="<?= base_url('assets/new/') ?>homepages/corporate-v7/images/blog/5.jpg" alt="">
                            ...
                            <div class="post-thumbnail-entry">
                                <img src="<?= base_url('assets/new/') ?>homepages/corporate-v7/images/blog/6.jpg" alt="">
                                <div class="post-thumbnail-content">
                            ...
                            <div class="post-thumbnail-entry">
                                <img src="<?= base_url('assets/new/') ?>homepages/corporate-v7/images/blog/7.jpg" alt="">
                                <div class="post-thumbnail-content">
                            ...
                            <div class="post-thumbnail-entry">
                                <img src="<?= base_url('assets/new/') ?>homepages/corporate-v7/images/blog/8.jpg" alt="">
                                <div class="post-thumbnail-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <div class="widget widget-newsletter">
                            <form class="widget-subscribe-form" action="https://inspirothemes.com/polo/include/subscribe-form.php" role="form" method="post" novalidate>
